...
Route::get('coordinador/destroy/{id}', ['as' => 'coordinador/destroy', 'uses'=>'coordinador@destroy']);
//ruta para realizar busqueda de registros.
Route::post('coordinador/search', ['as' => 'coordinador/search', 'uses'=>'coordinador@search']);
//----------------------------------------------------------------------------------------------------------------------//
