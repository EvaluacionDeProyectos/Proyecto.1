...
-- Volcando datos para la tabla evaluacioninstructores.detalle_ficha: ~10 rows (aproximadamente)
...
-- Volcando datos para la tabla evaluacioninstructores.ficha: ~224 rows (aproximadamente)
...
-- Volcando datos para la tabla evaluacioninstructores.instructor: ~75 rows (aproximadamente)
