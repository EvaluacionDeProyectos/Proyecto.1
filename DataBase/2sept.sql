...
INSERT INTO `aprendiz` (`Id_Aprendiz`, `Documento`, `Tipo_Documento`, `Nombres`, `Apellidos`, `Fecha_Nacimiento`, `Correo`, `Direccion`, `Telefono`, `Fecha_inicioLectiva`, `Fecha_finLectiva`, `Fecha_inicioProductiva`, `Fecha_finProductiva`, `Usuario`, `Contraseña`, `FK_Ficha`) VALUES
	(1, 971016, 'T.I.', 'Andres', 'Quintero', '1997-10-16', '-', '-', '-', '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', '-', NULL, 599557),
	(2, 981025, 'C.C.', 'Juan', 'Lopez', '2015-08-07', '-', '-', '-', '2015-08-07', '2015-08-07', '2015-08-07', '2015-08-07', '-', NULL, NULL);
...
INSERT INTO `centro` (`Codigo`, `Descripcion`, `Direccion`, `FK_Regional`) VALUES
	(254, 'GESTION ADMINISTRATIVA', '-', NULL),
...
CREATE TABLE IF NOT EXISTS `detalle_cuestionario` (
  ...
  `Estado` varchar(50) NOT NULL DEFAULT 'NoEvaluado',
...
-- Volcando datos para la tabla evaluacioninstructores.detalle_cuestionario: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `detalle_cuestionario` DISABLE KEYS */;
INSERT INTO `detalle_cuestionario` (`Id_detalleCuestionario`, `Estado`, `FK_Cuestionario`, `FK_Ficha`, `FK_Instructor`) VALUES
	(6, 'NoEvaluado', 3123, 912296, 21);
...
-- Volcando datos para la tabla evaluacioninstructores.detalle_pregunta: ~10 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `detalle_respuesta` (
  ...
  `FK_respuesta` int(5) DEFAULT NULL,
  KEY `FK_detalle_respuesta_aprendiz` (`FK_aprendiz`),
  KEY `FK_detalle_respuesta_respuesta` (`FK_respuesta`),
  CONSTRAINT `FK_detalle_respuesta_aprendiz` FOREIGN KEY (`FK_aprendiz`) REFERENCES `aprendiz` (`Id_Aprendiz`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_detalle_respuesta_respuesta` FOREIGN KEY (`FK_respuesta`) REFERENCES `respuesta` (`Id_Respuesta`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla evaluacioninstructores.detalle_respuesta: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `detalle_respuesta` DISABLE KEYS */;
INSERT INTO `detalle_respuesta` (`FK_aprendiz`, `FK_respuesta`) VALUES
	(1, 1),
	(1, 5),
	(1, 9),
	(1, 10),
...
CREATE TABLE IF NOT EXISTS `detalle_saber` (
  `FK_saber` int(5) DEFAULT NULL,
  `FK_pregunta` int(5) DEFAULT NULL,
  KEY `FK_detalle_saber_saber` (`FK_saber`),
  KEY `FK_detalle_saber_pregunta` (`FK_pregunta`),
  CONSTRAINT `FK_detalle_saber_pregunta` FOREIGN KEY (`FK_pregunta`) REFERENCES `pregunta` (`Id_pregunta`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_detalle_saber_saber` FOREIGN KEY (`FK_saber`) REFERENCES `saber` (`Codigo`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `detalle_saber` (`FK_saber`, `FK_pregunta`) VALUES
	(1, 1),
	(2, 1),
	(2, 2),
	(3, 3),
...
CREATE TABLE IF NOT EXISTS `pregunta` (
  ...
  `Descripcion` varchar(255) NOT NULL DEFAULT '-',
  `Indicacion` varchar(255) NOT NULL DEFAULT '-',
  PRIMARY KEY (`Id_pregunta`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla evaluacioninstructores.pregunta: ~11 rows (aproximadamente)
/*!40000 ALTER TABLE `pregunta` DISABLE KEYS */;
INSERT INTO `pregunta` (`Id_pregunta`, `Tipo_pregunta`, `Descripcion`, `Indicacion`) VALUES
...
-- Volcando datos para la tabla evaluacioninstructores.respuesta: ~30 rows (aproximadamente)
/*!40000 ALTER TABLE `respuesta` DISABLE KEYS */;
INSERT INTO `respuesta` (`Id_Respuesta`, `Valor_Respuesta`, `FK_Pregunta`) VALUES
	(1, 123, 1),
	(2, 70, 1),
	(3, 40, 1),
	(4, 100, 2),
