...
<body>
	...
	<div id="slider">
<figure>
<img src={{asset("image/Centro.JPG")}} alt="">
<img src={{asset("image/Cuarta.JPG")}} alt="">
<img src={{asset("image/Tercera.JPG")}} alt="">
<img src={{asset("image/Primera.JPG")}} alt="">
<img src={{asset("image/Segundo.JPG")}} alt="">
</figure>
</div>
	</div></p>
	@yield('content')
